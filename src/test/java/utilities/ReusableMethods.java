...
//        US17_US18_US19_US20_Page usPage = new US17_US18_US19_US20_Page();
//
//        ReusableMethods.bekle(1);
//        ReusableMethods.ddmVisibleText(usPage.chooseLessonDDMenu, ReusableMethods.getOptionsVisibleTextFromDDM(usPage.chooseLessonDDMenu));
//        ReusableMethods.bekle(1);
//        ReusableMethods.ddmVisibleText(usPage.chooseStudentDDMenu, ReusableMethods.getOptionsVisibleTextFromDDM(usPage.chooseStudentDDMenu));
//
//        usPage.studentNoteSubmitButton.click();
//        ReusableMethods.bekle(2);
//        if (usPage.infoAlert.getText().contains("Error: Student Info with")){
